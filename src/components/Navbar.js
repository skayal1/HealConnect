    ...
    <header>
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
        <div className="container">
          ...
          >
            <i className='bx bx-heart fs-4 nav-heads'></i>
            <span className="fw-bold fs-5 nav-heads">HealConnect</span>
          </div>
          {/* Hamburger */}
          <button
          ...
          <div className="collapse navbar-collapse d-none d-lg-flex justify-content-between">
            ...
            <div className="d-flex gap-2">
              <button className="modern-btn-outline" onClick={() => { setNavOpen(false); navigate("/login"); }}>
                <i className='bx bx-log-in'></i> Log in
              </button>
              <button className="modern-btn" onClick={() => { setNavOpen(false); navigate("/signup"); }}>
